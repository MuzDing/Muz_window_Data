	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="./index.jsp">首页&nbsp;&nbsp;&gt;</a> <a href="./蔬菜分类.htm">电子产品&nbsp;&nbsp;&gt;</a>
				<a>手机数码</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 400px; height: 350px;" title=""
						class="medium"
						src="${product_info.pimage }">
				</div>

				<div class="col-md-6">
					<div>
						<strong>${product_info.pname }</strong>
					</div>
					<div
						style="border-bottom: 1px dotted #dddddd; width: 350px; margin: 10px 0 10px 0;">
						编号:<div id="shop_pid">${product_info.pid }</div>
					</div>

					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${product_info.shop_price }元/份</strong> 参 考 价：
						<del>￥${product_info.market_price }元/份</del>
					</div>
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							 <a href="${pageContext.request.contextPath }/shoppingCart?pid=${product_info.pid}"> 
							 <input
								style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;"
								value="加入购物车" type="button" id ="op"> 
								</a>
							 &nbsp;收藏商品
						</div>
					</div>
