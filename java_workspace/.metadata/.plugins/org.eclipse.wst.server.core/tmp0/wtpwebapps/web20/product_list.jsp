...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items ="${pageBean.productList }" var="product">
			...
			<a href="${pageContext.request.contextPath }/selectProductById?pid=${product.pid }"> 
				<img src="${pageContext.request.contextPath }/${product.pimage }" width="170" height="170" style="display: inline-block;">
			</a>
			<p>
				<a href="${pageContext.request.contextPath }/selectProductById?pid=${product.pid }" style='color: green'>${product.pname }</a>
			</p>
			<p>
