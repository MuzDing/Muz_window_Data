		...
		btn_Enter.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				try{
					...
					//"jdbc:mysql://127.0.0.1:3306/imooc?useUnicode=true&amp;characterEncoding=utf-8";
			        String dbURL = "jdbc:mysql://127.0.0.1:3306/test?useUnicode=true&amp;characterEncoding=UTF-8"; // 连接服务器和数据库  
			        String userName = "root"; // 默认用户名  
			        String userPwd = "828521"; // 密码  
...
//					String SQL = "select * from users where Cuser = '" + txt_Name.getText()+"' and Cpw ='"+ txt_Password.getText() +"'";      //根据输入的信息查找员工信息
					//stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
					ResultSet rs= stmt.executeQuery("select * from users");	       //rs获取返回的数据集
					  //将数据显示出来		
					rs.next();
